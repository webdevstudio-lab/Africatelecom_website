          ...
          <div className="absolute right-0 hidden flex-row items-center justify-between lg:flex">
            <div className="flex flex-row items-center justify-between pr-4">
              <ul className="mr-4 flex flex-row items-center justify-between gap-4">
                <div className="flex h-[2.5rem] cursor-pointer flex-col items-center -space-y-[2px] px-2 py-1.5 text-[16px] font-semibold uppercase transition-all duration-100 hover:border-b-[3px] hover:border-blue-500 hover:text-blue-700">
                  <Link href="/">Home</Link>
                </div>
              ...
              <Link
                href="#"
                className="mx-auto cursor-pointer bg-blue-500 px-2 py-2 text-center text-[10px] font-medium text-white transition-all duration-200 hover:bg-blue-800"
              >
