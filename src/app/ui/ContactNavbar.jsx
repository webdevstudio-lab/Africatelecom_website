...
const ContactNavbar = () => {
  return (
    <div className="hidden bg-[#1F2544] py-1 text-xs text-white md:flex lg:flex">
      <MaxWidthContaine>
        <div className="item hidden flex-row justify-between bg-center md:flex lg:flex">
          ...
          <div className="flex-rox flex items-center justify-end gap-2">
            <Link
              className="cursor-pointer text-[11px] text-white hover:text-blue-400"
              href="#"
            >
              Careers
            </Link>
            <LinkedinIcon className="h-3.5 cursor-pointer text-blue-400" />
            <Facebook className="h-3.5 cursor-pointer text-blue-400" />
          </div>
        </div>
      </MaxWidthContaine>
    </div>
